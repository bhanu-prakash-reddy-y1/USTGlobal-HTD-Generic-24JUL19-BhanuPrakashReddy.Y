package com.dev.patternexpressions;
...
public class DigitsMatching {
	...
	public static void main(String[] args) {
		...
		pat = Pattern.compile("[0-9]|1[0-9]|2[0-9]|30[0-9]");// [] used to set range & {} used for number of digits or charctars
		mat = pat.matcher("301");
		System.out.println(mat.matches());
		/* "_"is taken as char in java RegEx */
